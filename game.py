import pygame, sys, random #Thư viện pygame, và thư viện sys
...
#tạo frame
pygame.init()
screen=pygame.display.set_mode((432,768)) #Hiển thị frame
...
bird_rect=bird.get_rect(center=(90,374))
#tạo timer cho bird
...
while True:
    ...
    screen.blit(bg,(0,0)) #Blit: Vẽ 1 surface này lên 1 surface khác
    if game_active:
        #chim
